...
# ══════════════════════════════════════════════════════════════════════════════
with tab_training:
    st.header("Trainingsdaten-Manager")
    ...
    if not _td_dbs:
        ...
        # Nur DBs mit sim_trades anzeigen
        ...
        if not _td_with_sim:
            ...
            if _td_selected_dbs:
                ...
                with _ex1:
                    # Ziel-DB auswählen oder neue anlegen
                    _existing_training = [
